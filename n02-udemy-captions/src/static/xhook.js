...
var xhook = (function () {
  ...
  const EventEmitter = function (nodeStyle) {
    ...
    emitter.dispatchEvent = function () {
      ...
      // console.log("legacylistener -->", legacylistener)
      if (legacylistener) {
  ...
  ***************************************************************************** */
   ...
   */
  const Xhook = function (input, init = {
    headers: {}
  }) {
    let options = Object.assign(Object.assign({}, init), {
      isFetch: true
    });
    ...
    return new Promise(function (resolve, reject) {
      ...
      const send = () => __awaiter(this, void 0, void 0, function* () {
        const {
          ...
          isFetch,
          acceptedRequest
        } = options, restInit = __rest(options, ["url", "isFetch", "acceptedRequest"]);
